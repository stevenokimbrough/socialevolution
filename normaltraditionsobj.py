...
File name: normaltraditionsobj.py, fromvoweltraditionsobj-1.py

Now the univariate normal as an experiment
"""
...
# =============================================================================
        ...
        for vname in self.vowelSystem:
            ...
            vpop = vowelObj.drawAVowel(vname, mu, sigma, size = 1000)
...
def doit(numGuys = 5,interactions = 1,coordination=True):
    '''
    Drives the action.
    '''
# =============================================================================
...
def plotMu(aMuList):
    ...
    '''
    plt.figure()
    x = list(range(len(aMuList)))
    y = aMuList
    plt.plot(x,y)

# =============================================================================
#     guyList = list(guys.keys())
#     for guyIdx in guyList:
#         guy = guys[guyIdx]
#         x = guy.getMuHistory('/i/')[:,0].astype(int)
#         y = guy.getMuHistory('/i/')[:,1]
#         plt.plot(x,y)
# =============================================================================

# =============================================================================
#     guyList = list(guys.keys())
#     for guy in guyList[:2]:
#     guy0 = guys[guyList[0]]
...
# =============================================================================
#     daGuys = doit(numGuys = 6,coordination=True)
# #    bob = daGuys[1]
#  #   carol = daGuys[2]
# # =============================================================================
